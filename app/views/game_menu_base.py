...
class GameMenuBase(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.btn_endless.setToolTip(tr('gm.play.endless', self._lang))
        self.btn_endless.clicked.connect(self.startEndless.emit)
        self.btn_story.setToolTip(tr('gm.play.story', self._lang))
        self.btn_story.clicked.connect(self.startStory.emit)
        self.btn_back.setToolTip(tr('gm.back', self._lang))
